            ...
            <div className="lg:flex lg:items-start lg:gap-8">
              ...
              <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <ul className="mt-6 space-y-4 text-sm">
                    <li>
                      <a href="#" className="text-offWhite_bg transition hover:text-brand"> Contact </a>
                    </li>
                    <li>
                      <a href="#" className="text-offWhite_bg transition hover:text-brand"> FAQs </a>
                    </li>
                    <li>
                      <a href="#" className="text-offWhite_bg transition hover:text-brand"> Live Chat </a>
                    </li>
                  </ul>
                </div>
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <ul className="mt-6 space-y-4 text-sm">
                    <li>
                      <a href="#" className="text-offWhite_bg transition hover:text-brand"> Accessibility </a>
                    </li>
                    <li>
                      <a href="#" className="text-offWhite_bg transition hover:text-brand"> Returns Policy </a>
                    </li>
                    <li>
                ...
                <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
                  <li>
                    <a href="/" rel="noreferrer" target="_blank" className="text-offWhite_bg transition hover:text-brand">
            ...
            <div className="mt-8 border-t border-gray-100 pt-8">
              <div className="sm:flex sm:justify-between">
                ...
                <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
                  ...
                  <li>
                    <a href="#" className="text-gray-500 transition hover:text-brand"> Privacy Policy </a>
                  </li>
                  <li>
                    <a href="#" className="text-gray-500 transition hover:text-brand"> Cookies </a>
                  </li>
                </ul>
              </div>
            </div>
